    					...
    					<div className="prospect-container">
							...
							<div id="recruiting-tracking">    						
								<div className="row">
									...
									<div className="col-sm-4 recruiting-tracking-btn background-blue"><h5>I RECEIVED A TEXT</h5></div>
									<div className="col-sm-4 recruiting-tracking-btn background-blue"><h5>I RECEIVED AN EMAIL</h5></div>
								</div>
								<div className="row">
									<div className="col-sm-4 recruiting-tracking-btn background-blue"><h5>I RECEIVED A PHONECALL</h5></div>
									<div className="col-sm-4 recruiting-tracking-btn background-blue"><h5>I WAS INVITED TO A CAMP</h5></div>
									<div className="col-sm-4 recruiting-tracking-btn background-blue"><h5>I HAD A PRIVATE WORKOUT</h5></div>
								</div>
								<div className="row">
									<div className="col-sm-4 recruiting-tracking-btn background-blue"><h5>I WAS INVITED TO CAMPUS</h5></div>
									<div className="col-sm-4 recruiting-tracking-btn background-blue"><h5>I WAS OFFERED</h5></div>
								</div>
							</div>
    					</div>
    				</div>
