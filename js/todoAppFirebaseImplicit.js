...
var TodoList3 = React.createClass({
  render: function() {
    ...
    var createItem = function(item, index) {
      return (
        <li key={ index }>
          <div>{ item.first /**this ".name" changes the attribute displayed in the todo list */ }</div>
          <div>{ item.position /**this ".name" changes the attribute displayed in the todo list */ }</div>
          <div>{ item.height /**this ".name" changes the attribute displayed in the todo list */ }</div>
