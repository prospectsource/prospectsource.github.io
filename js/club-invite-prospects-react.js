var ClubInviteProspects = React.createClass({
    		...
    		<div className="container">
    			<div className="row">
    				<div className="col-sm-12">
    					...
    					<p>You are now ready to invite your prospects to join our service. At any time, 
    					you may access your prospects recruiting information from your program dashboard. </p>
    				</div>
    			</div>
    	  	</div>
          	<button className="btn btn-default btn-large center-button program-button background-light-gray"><h2>Email invite system</h2></button>
    	</form>
    </section>
    );
  }
...
ReactDOM.render(<ClubInviteProspects />, document.getElementById('club-invite-prospects'));
